...
int main(void) {
    ...
    std::cout << "Reading Experiment6a.cl...";
    programFile = std::ifstream("Experiment6a.cl");
    ...
    std::cout << "Compiling Experiment6a.cl...";
    try {
    ...
    // Read file
    std::cout << "Enter the name of the file containing the image to luminate: ";
